...
class EventSessionPolicy
{
    ...
    {
        return $user->can('view_any_event::session');
    }
    ...
    {
        return $user->can('create_event::session');
    }
    ...
    {
        return $user->can('delete_any_event::session');
    }
    ...
    {
        return $user->can('force_delete_any_event::session');
    }
    ...
    {
        return $user->can('restore_any_event::session');
    }
    ...
    {
        return $user->can('reorder_event::session');
    }
